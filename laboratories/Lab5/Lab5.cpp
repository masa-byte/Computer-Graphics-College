...
// Lab5.cpp : Defines the class behaviors for the application.
//
...
// CLab5App construction

CLab5App::CLab5App() noexcept
{
...
// The one and only CLab5App object

CLab5App theApp;


// CLab5App initialization
